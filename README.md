...
- **Lightweight** – No external services required. Run the Api Explorer locally or embed it where you need it.

<p align="center">
  <img src="images/docs-sample.png" alt="Tracelet Api Explorer – routes sidebar and API details" width="720" />
</p>

*Tracelet API Explorer: route list and API details with params, body, and response.*
...
| [RUNNING LOCALLY](./docs/RUNNING-LOCALLY.md) | Run the app and Api Explorer |
